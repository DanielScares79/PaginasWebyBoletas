...
<head>
    ...
    <link rel="stylesheet" href="<?php echo WEB_URL; ?>/webprincipal/css/animate.css">
                    ...
                    <div class="blog_left_sidebar">
                        <article class="blog_item">
                            <div class="blog_item_img">
                                <img class="card-img rounded-0" src="<?php echo WEB_URL; ?>/webprincipal/img/blog/single_blog_1.png" alt="">
                        ...
                        <article class="blog_item">
                            <div class="blog_item_img">
                                <img class="card-img rounded-0" src="<?php echo WEB_URL; ?>/webprincipal/img/blog/single_blog_2.png" alt="">
                                <a href="#" class="blog_item_date">
                                    <h3>15</h3>
                                    <p>Jan</p>
                                </a>
                        ...
                        <article class="blog_item">
                            <div class="blog_item_img">
                                <img class="card-img rounded-0" src="<?php echo WEB_URL; ?>/webprincipal/img/blog/single_blog_3.png" alt="">
                                <a href="#" class="blog_item_date">
                                    <h3>15</h3>
                                    <p>Jan</p>
                                </a>
                        ...
                        <article class="blog_item">
                            <div class="blog_item_img">
                                <img class="card-img rounded-0" src="<?php echo WEB_URL; ?>/webprincipal/img/blog/single_blog_4.png" alt="">
                                <a href="#" class="blog_item_date">
                                    <h3>15</h3>
                                    <p>Jan</p>
                                </a>
                        ...
                        <article class="blog_item">
                            <div class="blog_item_img">
                                <img class="card-img rounded-0" src="<?php echo WEB_URL; ?>/webprincipal/img/blog/single_blog_5.png" alt="">
                                <a href="#" class="blog_item_date">
                                    <h3>15</h3>
                                    <p>Jan</p>
                                </a>
                    ...
                    <div class="blog_right_sidebar">
                        ...
                        <aside class="single_sidebar_widget popular_post_widget">
                            ...
                            <div class="media post_item">
                                <img src="<?php echo WEB_URL; ?>/webprincipal/img/post/post_1.png" alt="post">
                            ...
                            <div class="media post_item">
                                <img src="<?php echo WEB_URL; ?>/webprincipal/img/post/post_2.png" alt="post">
                                <div class="media-body">
                                    <a href="single-blog.php">
                            ...
                            <div class="media post_item">
                                <img src="<?php echo WEB_URL; ?>/webprincipal/img/post/post_3.png" alt="post">
                                <div class="media-body">
                                    <a href="single-blog.php">
                            ...
                            <div class="media post_item">
                                <img src="<?php echo WEB_URL; ?>/webprincipal/img/post/post_4.png" alt="post">
                                <div class="media-body">
                                    <a href="single-blog.php">
                        ...
                        <aside class="single_sidebar_widget instagram_feeds">
                            ...
                            <ul class="instagram_row flex-wrap">
                                <li>
                                    <a href="#">
                                        <img class="img-fluid" src="<?php echo WEB_URL; ?>/webprincipal/img/post/post_5.png" alt="">
                                    </a>
                                </li>
                                <li>
                                    <a href="#">
                                        <img class="img-fluid" src="<?php echo WEB_URL; ?>/webprincipal/img/post/post_6.png" alt="">
                                    </a>
                                </li>
                                <li>
                                    <a href="#">
                                        <img class="img-fluid" src="<?php echo WEB_URL; ?>/webprincipal/img/post/post_7.png" alt="">
                                    </a>
                                </li>
                                <li>
                                    <a href="#">
                                        <img class="img-fluid" src="<?php echo WEB_URL; ?>/webprincipal/img/post/post_8.png" alt="">
                                    </a>
                                </li>
                                <li>
                                    <a href="#">
                                        <img class="img-fluid" src="<?php echo WEB_URL; ?>/webprincipal/img/post/post_9.png" alt="">
                                    </a>
                                </li>
                                <li>
                                    <a href="#">
                                        <img class="img-fluid" src="<?php echo WEB_URL; ?>/webprincipal/img/post/post_10.png" alt="">
                                    </a>
                                </li>
                            </ul>
                        </aside>
